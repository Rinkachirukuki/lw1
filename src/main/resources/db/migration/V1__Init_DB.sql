...
CREATE TABLE `review` (
  ...
  KEY `FKc5ins2nksp4wrkoiusu9quc3g` (`driver_id`),
  CONSTRAINT `FKc5ins2nksp4wrkoiusu9quc3g` FOREIGN KEY (`driver_id`) REFERENCES `driver` (`driver_id`),
...
CREATE TABLE `taxi_order` (
  ...
  KEY `FKiy7t3e104f5shmybgom88rowe` (`customer_id`),
  KEY `FK9ijxng0fdl7ts2rofoiph62wi` (`vehicle_id`),
  CONSTRAINT `FK9ijxng0fdl7ts2rofoiph62wi` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`vehicle_id`),
  CONSTRAINT `FKiy7t3e104f5shmybgom88rowe` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
